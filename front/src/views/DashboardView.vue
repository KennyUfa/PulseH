      ...
      >
        <div class="card-main">
          ...
          <div class="card-right">
            <span v-if="survey.is_anonymous !== undefined" class="type-badge">
              {{ survey.is_anonymous ? 'Анон' : 'ID' }}
            </span>
...
.title { font-size: 1.25rem; font-weight: 800; color: #1a1a1a; font-family: 'Manrope', sans-serif; }
...
.dd-item {
  ...
  font-family: 'Manrope', sans-serif; border-radius: 6px;
...
.search-input {
  ...
  color: #fff; font-size: 0.9rem; font-family: 'Manrope', sans-serif;
